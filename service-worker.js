const CACHE = "lifeos-capture-shell-v6";
const SHELL = ["./index.html", "./styles.css", "./sync.css", "./protocol.js", "./storage.js", "./attachments.js", "./zip.js", "./runtime.js", "./transports.js", "./i18n.js", "./app.js", "./manifest.webmanifest", "./icon.svg"];
